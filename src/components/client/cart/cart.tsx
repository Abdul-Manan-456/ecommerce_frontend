...
import { CHECKOUT_CART } from "@/lib/redux/slices/cart/cartSlice";
const Cart = () => {
    const buttonsData = [
        ...
        <div className="flex  flex-col items-center p-8">
            ...
            <div className="w-full mt-8 grid grid-cols-3 gap-6">
                ...
                <div className="">
                    ...
                    <Textarea onChange={(e) => handleTextareaValue(e)} className="h-28" placeholder="Please Leave Special Instruction" />
                            ...
                            buttonsData.map((button, index) => (
                                <div key={index} className="">
                                    ...
                                    <Link href={button.link} >
                                        ...
                                        <Button
                                            onClick={button.text === 'Checkout' ? handleCheckoutCart : undefined}
                                            variant={"default"} className="w-48 rounded-none hover:bg-success" >{button.text}
                                        </Button>
                                    </Link>
